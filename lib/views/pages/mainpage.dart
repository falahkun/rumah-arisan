    ...
    return Scaffold(
      body: BlocBuilder<AuthBloc, AuthState>(builder: (context, authState) {
        if (authState is OnLoadedToken) {
          context
              .bloc<CloterBloc>()
              .add(LoadCloter(authState.tokenResult.data.token));
          context
              .bloc<SliderBloc>()
              .add(LoadSlider(authState.tokenResult.data.token));
          context
              .bloc<CommunitiesBloc>()
              .add(LoadCommunities(authState.tokenResult.data.token));
          ...
          print("event is unauthorized state");
