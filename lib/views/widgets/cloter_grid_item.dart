...
class CloterGridItem extends StatelessWidget {
  ...
  const CloterGridItem({Key key, this.cloter, this.memberToken})
      : super(key: key);
  @override
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                padding: const EdgeInsets.only(left: 10.71, right: 10.71),
              ...
              Container(
                child: Text(
                  cloter.angsuran ?? "-",
                  // "Rp 1.000.000",
                  style: bold.copyWith(fontSize: 14, color: Color(0xFFA9010E)),
                  textAlign: TextAlign.left,
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                ),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 10.71, right: 9.64),
                child: Row(
                  children: [
                    Text(
                      "Kuota : ${cloter.kuota}",
